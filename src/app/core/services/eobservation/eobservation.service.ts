...
export class EObservationService extends BaseService {
    ...
    public getEObservationTypeLabel(eObservation: EObservationModel): string {
        if (eObservation) {
            ...
            let typeSuffix = '';
            if (eObservation && (eObservation.type !== EObservationTypeEnum.E_PCB) && eObservation.subType && (eObservation.subType !== EObservationSubTypeEnum.CLASSICAL) && (eObservation.subType !== EObservationSubTypeEnum.VAC)) {
