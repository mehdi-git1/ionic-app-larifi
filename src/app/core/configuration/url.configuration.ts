...
export class UrlConfiguration {
  ...
  public backEndUrlList: {} = {
    ...
    'getCrewMembersFromLegWithoutID': `${urlGroupEnum.LEG}/crew_members/{company}/{flightNumber}/{date}/{origine}/{destination}`,
    ...
    'getAllRotationByMatricule': `${urlGroupEnum.PNC}/{matricule}/rotations`,
