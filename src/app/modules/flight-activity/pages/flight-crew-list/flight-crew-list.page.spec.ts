...
import { Speciality } from '../../../../core/services/speciality/speciality.service';
...
describe('FlightCrewListPage', () => {
    ...
    function createCrewMember(prioritized: boolean, particularity: string, speciality: Speciality, lastName: string): CrewMemberEnum {
