...
import { MyBoardHomePage } from '../modules/my-board/pages/my-board-home/my-board-home.page';
...
import { CacheExplorerPage } from '../modules/settings/pages/cache-explorer/cache-explorer.page';
...
const routes: Routes = [
    ...
    children: [
      ...
      },
      {
        path: 'search', children: [
          ...
          { path: 'filters-opened', component: PncSearchPage }
        ]
      },
      {
  ...
  { path: 'authentication', component: AuthenticationPage },
  {
    ...
    path: 'visit/:matricule', canActivate: [TeacherGuard], children: [
      { path: 'development-program', component: DevelopmentProgramPage },
      {
        path: 'eobservation', children: [
  ...
  { path: 'admin/cache-explorer', canActivate: [RealAdminGuard], component: CacheExplorerPage },
